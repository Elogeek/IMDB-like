    <div class="frise">
        <img src="../asset/img/frise.png" id="friseImg" alt="ma super frise">
        <div id="links">
    ...
    <script src="https://cdn.jsdelivr.net/npm/@splidejs/splide@latest/dist/js/splide.min.js" type="module"></script>
</body>
</html>
